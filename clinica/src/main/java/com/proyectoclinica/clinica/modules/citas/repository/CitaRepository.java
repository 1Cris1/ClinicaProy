...
public interface CitaRepository extends JpaRepository<Cita, Integer> {
    ...
    // Búsquedas básicas
    // EXPOSICIÓN MIGUEL: Se usa @EntityGraph para traer las relaciones de paciente y medico en un solo JOIN FETCH. 
    // Esto resuelve el problema N+1, donde JPA haría 1 consulta por las citas + N consultas extras para traer los pacientes/medicos.
