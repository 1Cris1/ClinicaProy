...
public class PasswordResetController {
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody Map<String, String> request) {
        ...
        if (usuarioOpt.isEmpty()) {
            ...
            return ResponseEntity
                    .ok(Map.of("success", true, "message", "Si el correo existe, se le enviará un código."));
        }

        Usuario usuario = usuarioOpt.get();
        // Generar código y enviar correo de forma asíncrona (podría usarse @Async, pero
        // lo dejamos simple)
        try {
    ...
    public ResponseEntity<?> verifyCode(@RequestBody Map<String, String> request) {
        ...
        if (isValid) {
            ...
            return ResponseEntity.badRequest()
                    .body(Map.of("success", false, "message", "El código es incorrecto o ha expirado"));
        }
    }
    ...
    public ResponseEntity<?> resetPassword(@RequestBody Map<String, String> request) {
        ...
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(Map.of("success", false, "message", "Error interno al actualizar la contraseña"));
        }
    }
}
