    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/", "/inicio", "/especialidades", "/medicos", "/servicios", "/promociones", "/sedes", "/blog", "/contacto", "/login", "/registro", "/api/test/users", "/api/password/**", "/api/identidad/**", "/api/colegiatura/**", "/error").permitAll()
